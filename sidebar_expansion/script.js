...
new Chart(document.getElementById("chartAndroid"), {
  type: 'line',
  data: chartData("#e63946"),
  options: lineOptions
});

new Chart(document.getElementById("chartIOS"), {
  type: 'line',
  data: chartData("#457b9d"),
  options: lineOptions
});

new Chart(document.getElementById("chartWeb"), {
  type: 'line',
  data: chartData("#f4a261"),
  options: lineOptions
});
